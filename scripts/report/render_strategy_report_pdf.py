...
FIGURES_BY_SECTION = {
    "4. 回测表现": [
        ("策略累计收益与基准对比", PROJECT_ROOT / "output/cne6/images/backtest/factor_timing_l20_s5_b2_e1_n100.png"),
    ],
    "5. 风格收益归因": [
        ("全样本 CNE6 风格因子收益归因", PROJECT_ROOT / "output/cne6/images/analysis/style_factor_attribution_summary_l20_s5_b2_e1_n100.png"),
    ],
    "6. 分时段归因": [
        ("分时段风格收益归因与净值曲线联动", PROJECT_ROOT / "output/cne6/images/analysis/style_factor_attribution_regime_summary_l20_s5_b2_e1_n100.png"),
    ],
    "7. 风格择时有效性与持仓兑现": [
        ("风格择时有效性表", PROJECT_ROOT / "output/cne6/images/analysis/style_timing_effectiveness_table_l20_s5_b2_e1_n100.png"),
        ("持仓内部风格暴露质量表", PROJECT_ROOT / "output/cne6/images/analysis/style_holding_exposure_quality_table_l20_s5_b2_e1_n100.png"),
    ],
    "8. 交易成本、成交约束与参数验证": [
        ("旧单边交易成本压力测试", PROJECT_ROOT / "output/cne6/images/analysis/transaction_cost_stress_l20_s5_b2_e1_n100.png"),
        ("双边建仓与 ADV 冲击成本主口径", PROJECT_ROOT / "output/cne6/images/analysis/transaction_cost_realistic_l20_s5_b2_e1_n100.png"),
    ],
    "8.1 成交可实现性与容量约束": [
        ("成交可实现性与容量约束实验", PROJECT_ROOT / "output/cne6/images/optimize/execution_capacity_experiment_l20_s5_b2_e1_n100.png"),
    ],
    "8.2 成交约束下的换手参数重估": [
        ("成交约束下换手参数重估", PROJECT_ROOT / "output/cne6/images/optimize/execution_turnover_revaluation_l20_s5_b2_e1_n100.png"),
    ],
    "8.3 成交约束下的 walk-forward 验证": [
        ("成交约束下换手参数 walk-forward 验证", PROJECT_ROOT / "output/cne6/images/optimize/execution_turnover_walk_forward_l20_s5_b2_e1_n100.png"),
    ],
    "8.4 主策略核心参数稳定性验证": [
        ("主策略核心参数稳定性验证", PROJECT_ROOT / "output/cne6/images/optimize/core_parameter_stability_l20_s5_b2_e1_n100.png"),
    ],
    "9. Residual 归因": [
        ("Residual 归因总览", PROJECT_ROOT / "output/cne6/images/analysis/residual_attribution_l20_s5_b2_e1_n100.png"),
    ],
}
...
<body>
  <section class="cover">
    ...
    <div class="subtitle">基于项目架构、周度回测、风格归因、交易成本压力测试、换手控制实验与 residual 归因的综合研究版。</div>
    <div class="cover-grid">
      <div class="cover-card"><b>5.89</b><span>期末净值</span></div>
      <div class="cover-card"><b>35.4%</b><span>年化收益</span></div>
      <div class="cover-card"><b>-20.0%</b><span>最大回撤</span></div>
      <div class="cover-card"><b>49.7%</b><span>平均单边换手</span></div>
    </div>
    <div class="cover-meta">报告日期：2026-05-11<br/>数据区间：2020-02-17 至 2025-12-22</div>
  </section>
  <div class="page">
    {toc}
    <main>
